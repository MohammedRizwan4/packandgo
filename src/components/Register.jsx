...
const Register = ({ openRegister, setOpenRegister, setOpenLogin }) => {
    ...
    const onSubmit = async (values, actions) => {
        toast.promise(
            ...
            {
                loading: 'Saving...',
                success: <b style={{ fontSize: "2rem" }}>Registration SuccessFull</b>
            }
        );
        // registerData(values)
        // actions.resetForm();
    ...
    return createPortal(
        <>{openRegister && <>
            ...
            <RegComponent openRegister={openRegister}>
                <div className="closeIcon">
                    <div className="title">Register</div>
                    <HighlightOffIcon className='icon' onClick={setOpenRegister}>close</HighlightOffIcon>
                </div>
                <div className="login">
                    <form className='inputs' onSubmit={handleSubmit} autoComplete="off">
                        <div className="input firstName">
                            <label htmlFor="firstName">First Name</label>
                            <input value={values.firstName} id="firstName" onChange={handleChange} onBlur={handleBlur} className={errors.firstName && touched.firstName ? "input-error" : ""} type="text" placeholder='Enter your FirstName' />
                            {errors.firstName && touched.firstName && <p className='error'>{errors.firstName}</p>}
                        </div>
                        <div className="input lastName">
                            <label htmlFor="lastName">Last Name</label>
                            <input value={values.lastName} id="lastName" onChange={handleChange} onBlur={handleBlur} className={errors.lastName && touched.lastName ? "input-error" : ""} type="text" placeholder='Enter your LastName' />
                        ...
                        <div className="input confirmPassword">
                            ...
                            <input value={values.confirmPassword} id="confirmPassword" onChange={handleChange} onBlur={handleBlur} className={errors.confirmPassword && touched.confirmPassword ? "input-error" : ""} type="password" placeholder='Enter your Confirm Password' />
            ...
            <Opacity onClick={() => setOpenRegister(false)} />
        </>
        }
